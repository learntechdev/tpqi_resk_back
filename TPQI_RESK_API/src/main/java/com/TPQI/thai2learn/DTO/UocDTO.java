...
public class UocDTO {
    ...
    public List<EocDTO> getElementsOfCompetency() { return elementsOfCompetency; }
    public void setElementsOfCompetency(List<EocDTO> elementsOfCompetency) { this.elementsOfCompetency = elementsOfCompetency; }
