...
public class CBRepositoryImpl implements CBRepository {
    ...
    @Override
    public Page<CbApplicantSummaryDTO> findApplicantSummaries(String orgCode, String search, String status, Pageable pageable) {
        ...
        StringBuilder whereClause = new StringBuilder("WHERE es.org_id = :orgCode ");
