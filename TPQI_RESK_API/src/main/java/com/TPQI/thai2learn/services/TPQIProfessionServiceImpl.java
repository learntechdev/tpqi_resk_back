...
@Service
public class TPQIProfessionServiceImpl implements TPQIProfessionService {
    ...
    public List<TPQIProfessionDTO> getTpqiProfessionData() {
        ...
        for (Object[] row : resultList) {
            ...
            dto.setTpqiProfessionProfessionCode(row[1] != null ? row[1].toString() : null);         
            dto.setTpqiProfessionProfessionName(row[2] != null ? row[2].toString() : null);         
            dto.setTpqiProfessionStatus(row[3] != null ? row[3].toString() : null);                 
